...
const registerUser = asyncHandler(async(req,res) => {
  ...
  //  upload them to cloudinary server, avatar check
...
const updateUserAvatar = asyncHandler(async(req,res) => {
  ...
  const oldAvatarDelete = await delteOnCloudinary(oldAvatarPublicId);

  if(!oldAvatarDelete){
    throw new ApiError(500,"Something went wrong while delteing old avatar");
  }

  // to upload new image to cloudiary now 
